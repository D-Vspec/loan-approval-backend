...
Revision ID: 79486a7aa449
Revises: 
Create Date: 2025-07-21 19:00:06.407340
...
def upgrade():
    ...
    sa.Column('id', sa.Integer(), nullable=False),
    sa.Column('client_id', sa.Integer(), nullable=True),
    sa.Column('benefits_received', sa.Enum('NoBenefitsReceived', 'ReceivedOnlyOneBenefit', 'ReceivedTwoOrMoreBenefits', name='programbenefitsenum'), nullable=False),
    sa.Column('custom_description', sa.String(length=255), nullable=True),
    sa.Column('score', sa.Integer(), nullable=True),
    sa.ForeignKeyConstraint(['client_id'], ['client.id'], ondelete='CASCADE'),
    sa.PrimaryKeyConstraint('id')
